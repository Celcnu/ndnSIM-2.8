...
class DummyModule : public Module {
  public:
    ...
    void
    fetchStatus(Controller&, const std::function<void()>& onSuccess, const Controller::DatasetFailCallback& onFailure,
...
class StatusReportModulesFixture : public ClockFixture, public KeyChainFixture {
  protected:
    ...
    {
        report.processEventsFunc = [=] { this->advanceClocks(tick, nTicks); };
