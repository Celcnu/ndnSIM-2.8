...
class PitFibBenchmarkFixture {
  protected:
    ...
    void
    generatePacketsAndPopulateFib(size_t nPackets, size_t nFibEntries, size_t fibPrefixLength,
                                  size_t interestNameLength, size_t dataNameLength)
    {
...
BOOST_FIXTURE_TEST_CASE(SimpleExchanges, PitFibBenchmarkFixture)
{
    ...
    generatePacketsAndPopulateFib(nRoundTrip, nFibEntries, fibPrefixLength, interestNameLength, dataNameLength);
