...
class PitExpiryTestStrategy : public DummyStrategy {
  public:
    ...
    explicit PitExpiryTestStrategy(Forwarder& forwarder, const Name& name = getStrategyName(1))
    ...
    void
    afterContentStoreHit(const shared_ptr<pit::Entry>& pitEntry, const FaceEndpoint& ingress, const Data& data) override
    {
