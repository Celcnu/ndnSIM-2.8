...
using Tests = boost::mpl::vector<Test<AccessStrategy, false, false>, Test<AsfStrategy, true, false>,
                                 Test<BestRouteStrategy, false, false>, Test<BestRouteStrategy2, true, true>,
                                 Test<MulticastStrategy, true, true>, Test<NccStrategy, false, false>,
                                 Test<RandomStrategy, true, true>>;

BOOST_FIXTURE_TEST_CASE_TEMPLATE(LocalhostInterestToLocal, T, Tests, StrategyScopeControlFixture<typename T::Strategy>)
{
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(LocalhostInterestToNonLocal, T, Tests,
                                 StrategyScopeControlFixture<typename T::Strategy>)
{
    fib::Entry* fibEntry = this->fib.insert("/localhost/A").first;
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(LocalhostInterestToLocalAndNonLocal, T, Tests,
                                 StrategyScopeControlFixture<typename T::Strategy>)
{
    fib::Entry* fibEntry = this->fib.insert("/localhost/A").first;
    this->fib.addOrUpdateNextHop(*fibEntry, *this->nonLocalFace2, 10);
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(LocalhopInterestToNonLocal, T, Tests,
                                 StrategyScopeControlFixture<typename T::Strategy>)
{
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(LocalhopInterestToNonLocalAndLocal, T, Tests,
                                 StrategyScopeControlFixture<typename T::Strategy>)
{
    fib::Entry* fibEntry = this->fib.insert("/localhop/A").first;
    this->fib.addOrUpdateNextHop(*fibEntry, *this->nonLocalFace2, 10);
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(LocalhostNackToNonLocal, T, Tests, StrategyScopeControlFixture<typename T::Strategy>)
{
    fib::Entry* fibEntry = this->fib.insert("/localhost/A").first;
    this->fib.addOrUpdateNextHop(*fibEntry, *this->localFace4, 10);
    ...
    BOOST_REQUIRE(
      this->strategy
        .waitForAction([&] { this->strategy.afterReceiveNack(FaceEndpoint(*this->localFace4, 0), nack, pitEntry); },
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(LocalhopNackToNonLocal, T, Tests, StrategyScopeControlFixture<typename T::Strategy>)
{
    fib::Entry* fibEntry = this->fib.insert("/localhop/A").first;
    this->fib.addOrUpdateNextHop(*fibEntry, *this->localFace4, 10);
    this->fib.addOrUpdateNextHop(*fibEntry, *this->nonLocalFace2, 20);
