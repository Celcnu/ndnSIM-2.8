...
BOOST_AUTO_TEST_CASE(InOutRecords)
{
    ...
    BOOST_CHECK_LE(in1->getExpiry() - in1->getLastRenewed() - interest1->getInterestLifetime(), after1 - before1);
    ...
    BOOST_CHECK_LE(out1->getExpiry() - out1->getLastRenewed() - interest1->getInterestLifetime(), after2 - before2);
    ...
    BOOST_CHECK_LE(in2->getExpiry() - in2->getLastRenewed() - interest2->getInterestLifetime(), after3 - before3);
