...
using FixtureAndAddressList = boost::mpl::vector<
  FixtureAndAddress<TcpChannelFixture, AddressFamily::V4>, FixtureAndAddress<TcpChannelFixture, AddressFamily::V6>,
  FixtureAndAddress<UdpChannelFixture, AddressFamily::V4>, FixtureAndAddress<UdpChannelFixture, AddressFamily::V6>>;
