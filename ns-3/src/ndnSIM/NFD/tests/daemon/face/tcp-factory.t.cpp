...
BOOST_AUTO_TEST_CASE(ConfigureLocal)
{
    ...
    createFace(factory, FaceUri("tcp4://127.0.0.1:6363"), {},
               {ndn::nfd::FACE_PERSISTENCY_PERSISTENT, {}, {}, {}, false, false, false},
               {CreateFaceExpectedResult::SUCCESS, 0, ""},
               [](const nfd::Face& face) { BOOST_CHECK_EQUAL(face.getScope(), ndn::nfd::FACE_SCOPE_LOCAL); });
...
BOOST_AUTO_TEST_CASE(ConfigureNonLocal)
{
    ...
    createFace(factory, FaceUri("tcp4://127.0.0.1:6363"), {},
               {ndn::nfd::FACE_PERSISTENCY_PERSISTENT, {}, {}, {}, false, false, false},
               {CreateFaceExpectedResult::SUCCESS, 0, ""},
               [](const nfd::Face& face) { BOOST_CHECK_EQUAL(face.getScope(), ndn::nfd::FACE_SCOPE_NON_LOCAL); });
...
BOOST_AUTO_TEST_CASE(CreateFace)
{
    ...
    createFace(factory, FaceUri("tcp4://127.0.0.1:20072"), {},
               {ndn::nfd::FACE_PERSISTENCY_PERMANENT, {}, {}, {}, false, false, false},
               {CreateFaceExpectedResult::SUCCESS, 0, ""});

    createFace(factory, FaceUri("tcp4://127.0.0.1:20073"), {},
...
BOOST_AUTO_TEST_CASE(UnsupportedCreateFace)
{
    ...
    createFace(factory, FaceUri("tcp4://127.0.0.1:20072"), FaceUri("tcp4://127.0.0.1:20071"),
               {ndn::nfd::FACE_PERSISTENCY_PERSISTENT, {}, {}, {}, false, false, false},
               {CreateFaceExpectedResult::FAILURE, 406, "Unicast TCP faces cannot be created with a LocalUri"});

    createFace(factory, FaceUri("tcp4://127.0.0.1:20072"), {},
               {ndn::nfd::FACE_PERSISTENCY_ON_DEMAND, {}, {}, {}, false, false, false},
               {CreateFaceExpectedResult::FAILURE, 406, "Outgoing TCP faces do not support on-demand persistency"});

    createFace(factory, FaceUri("tcp4://198.51.100.100:6363"), {},
    ...
    createFace(factory, FaceUri("tcp4://127.0.0.1:20072"), {},
               ...
               {CreateFaceExpectedResult::FAILURE, 406, "TCP faces do not support MTU overrides"});
}
