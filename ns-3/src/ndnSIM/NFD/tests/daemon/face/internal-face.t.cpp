...
BOOST_AUTO_TEST_CASE(ReceiveInterestTimeout)
{
    ...
    clientFace->expressInterest(*interest, bind([] { BOOST_ERROR("unexpected Data"); }),
...
BOOST_AUTO_TEST_CASE(ReceiveInterestSendNack)
{
    ...
    clientFace->expressInterest(
      *interest, bind([] { BOOST_ERROR("unexpected Data"); }),
