...
class NetworkInterfacePredicateFixture : public NetworkPredicateBaseFixture<NetworkInterfacePredicate> {
  protected:
    NetworkInterfacePredicateFixture()
    {
        ...
        netifs.back()->addNetworkAddress(NetworkAddress(AddressFamily::V4, address_v4::from_string("129.82.100.1"),
                                                        address_v4::from_string("129.82.255.255"), 16,
                                                        AddressScope::GLOBAL, 0));
        netifs.back()->addNetworkAddress(NetworkAddress(AddressFamily::V6, address_v6::from_string("2001:db8:1::1"),
                                                        address_v6::from_string("2001:db8:1::ffff:ffff:ffff:ffff"), 64,
                                                        AddressScope::GLOBAL, 0));
        ...
        netifs.back()->addNetworkAddress(NetworkAddress(AddressFamily::V4, address_v4::from_string("192.168.2.1"),
                                                        address_v4::from_string("192.168.2.255"), 24,
                                                        AddressScope::GLOBAL, 0));
        netifs.back()->addNetworkAddress(NetworkAddress(AddressFamily::V6, address_v6::from_string("2001:db8:2::1"),
                                                        address_v6::from_string("2001:db8:2::ffff:ffff:ffff:ffff"), 64,
                                                        AddressScope::GLOBAL, 0));
        netifs.back()->setFlags(IFF_UP);
        ...
        netifs.back()->addNetworkAddress(NetworkAddress(AddressFamily::V4, address_v4::from_string("198.51.100.1"),
                                                        address_v4::from_string("198.51.100.255"), 24,
                                                        AddressScope::GLOBAL, 0));
        netifs.back()->addNetworkAddress(NetworkAddress(AddressFamily::V6, address_v6::from_string("2001:db8::1"),
                                                        address_v6::from_string("2001:db8::ffff"), 112,
                                                        AddressScope::GLOBAL, 0));
        ...
        netifs.back()->addNetworkAddress(NetworkAddress(AddressFamily::V4, address_v4::from_string("192.168.2.3"),
                                                        address_v4::from_string("192.168.2.255"), 24,
                                                        AddressScope::GLOBAL, 0));
        netifs.back()->setFlags(IFF_UP);
    }
...
{
    BOOST_CHECK_THROW(parseConfig("whitelist\n"
                                  "{\n"
                                  "  ifname\n"
                                  "}"),
                      ConfigFile::Error);
...
{
    BOOST_CHECK_THROW(parseConfig("blacklist\n"
                                  "{\n"
                                  "  ether foo\n"
                                  "}"),
                      ConfigFile::Error);
