...
BOOST_AUTO_TEST_CASE(Empty)
{
    ...
    BOOST_CHECK_EQUAL(n.doesContain(address::from_string("2001:db8:3f9:0:3025:ccc5:eeeb:86d3")), false);
    ...
    BOOST_CHECK_EQUAL(n.doesContain(address::from_string("ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff")), false);
}
...
BOOST_AUTO_TEST_CASE(MaxRangeV4)
{
    ...
    BOOST_CHECK_EQUAL(n.doesContain(address::from_string("2001:db8:3f9:1:3025:ccc5:eeeb:86d3")), false);
...
BOOST_AUTO_TEST_CASE(MaxRangeV6)
{
    ...
    BOOST_CHECK_EQUAL(n.doesContain(address::from_string("192.0.2.1")), false);
    BOOST_CHECK_EQUAL(n.doesContain(address::from_string("2001:db8:3f9:1:3025:ccc5:eeeb:86d3")), true);

    BOOST_CHECK_EQUAL(n.doesContain(address::from_string("0.0.0.1")), false);
    BOOST_CHECK_EQUAL(n.doesContain(address::from_string("255.255.255.255")), false);

    BOOST_CHECK_EQUAL(n.doesContain(address::from_string("::")), true);
    BOOST_CHECK_EQUAL(n.doesContain(address::from_string("ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff")), true);
}

BOOST_AUTO_TEST_CASE(RangeV6)
{
    Network n = boost::lexical_cast<Network>("2001:db8:3f9:1::/64");
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(n), "2001:db8:3f9:1:: <-> 2001:db8:3f9:1:ffff:ffff:ffff:ffff");
    ...
    BOOST_CHECK_EQUAL(n.doesContain(address::from_string("192.0.2.1")), false);
    BOOST_CHECK_EQUAL(n.doesContain(address::from_string("2001:db8:3f9:1:3025:ccc5:eeeb:86d3")), true);
    BOOST_CHECK_EQUAL(n.doesContain(address::from_string("2001:db8:3f9:1::")), true);
    BOOST_CHECK_EQUAL(n.doesContain(address::from_string("2001:db8:3f9:1:ffff:ffff:ffff:ffff")), true);
    BOOST_CHECK_EQUAL(n.doesContain(address::from_string("2001:db8:3f9:0:ffff:ffff:ffff:ffff")), false);
    BOOST_CHECK_EQUAL(n.doesContain(address::from_string("2001:db8:3f9:2::")), false);
...
{
    BOOST_CHECK_EQUAL(boost::lexical_cast<Network>("192.0.2.0/24"), boost::lexical_cast<Network>("192.0.2.127/24"));

    BOOST_CHECK_EQUAL(boost::lexical_cast<Network>("2001:db8:3f9:0::/64"),
                      boost::lexical_cast<Network>("2001:db8:3f9:0:ffff::/64"));

    BOOST_CHECK_NE(boost::lexical_cast<Network>("192.0.2.0/24"), boost::lexical_cast<Network>("192.0.3.127/24"));

    BOOST_CHECK_NE(boost::lexical_cast<Network>("2001:db8:3f9:0::/64"),
                   boost::lexical_cast<Network>("2001:db8:3f9:1::/64"));

    BOOST_CHECK_NE(boost::lexical_cast<Network>("192.0.2.0/24"), boost::lexical_cast<Network>("2001:db8:3f9:0::/64"));
}
