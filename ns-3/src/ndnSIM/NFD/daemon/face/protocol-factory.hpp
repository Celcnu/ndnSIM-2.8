...
class ProtocolFactory : noncopyable {
  ...
  public:
    ...
    explicit ProtocolFactory(const CtorParams& params);
     ...
     */
    void createFace(const CreateFaceRequest& req, const FaceCreatedCallback& onCreated,
     ...
     */
    shared_ptr<Face>
    createNetdevBoundFace(const FaceUri& remote, const shared_ptr<const ndn::net::NetworkInterface>& netdev);
  ...
  private:
     ...
     */
    virtual void doProcessConfig(OptionalConfigSection configSection, FaceSystem::ConfigContext& context);
     ...
     */
    virtual void doCreateFace(const CreateFaceRequest& req, const FaceCreatedCallback& onCreated,
                              const FaceCreationFailedCallback& onFailure);
    ...
    doCreateNetdevBoundFace(const FaceUri& remote, const shared_ptr<const ndn::net::NetworkInterface>& netif);
     ...
     */
    virtual std::vector<shared_ptr<const Channel>> doGetChannels() const;
