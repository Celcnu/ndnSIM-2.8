...
UdpChannel::UdpChannel(const udp::Endpoint& localEndpoint, time::nanoseconds idleTimeout, bool wantCongestionMarking)
...
void
UdpChannel::connect(const udp::Endpoint& remoteEndpoint, const FaceParams& params,
...
void
UdpChannel::listen(const FaceCreatedCallback& onFaceCreated, const FaceCreationFailedCallback& onFaceCreationFailed)
{
    if (isListening()) {
...
void
UdpChannel::waitForNewPeer(const FaceCreatedCallback& onFaceCreated, const FaceCreationFailedCallback& onReceiveFailed)
{
...
void
UdpChannel::handleNewPeer(const boost::system::error_code& error, size_t nBytesReceived,
...
UdpChannel::createFace(const udp::Endpoint& remoteEndpoint, const FaceParams& params)
{
    ...
    auto transport =
      make_unique<UnicastUdpTransport>(std::move(socket), params.persistency, m_idleFaceTimeout, params.mtu);
