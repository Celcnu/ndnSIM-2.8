...
class FaceInfo {
  public:
    explicit FaceInfo(shared_ptr<const ndn::util::RttEstimator::Options> opts)
...
class NamespaceInfo : public StrategyInfo {
  public:
    ...
    explicit NamespaceInfo(shared_ptr<const ndn::util::RttEstimator::Options> opts)
...
class AsfMeasurements : noncopyable {
  public:
    explicit AsfMeasurements(MeasurementsAccessor& measurements);
  ...
  private:
    void extendLifetime(measurements::Entry& me);
