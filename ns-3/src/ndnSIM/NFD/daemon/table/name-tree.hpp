...
class NameTree : noncopyable {
  ...
  public: // matching
    ...
    template <typename EntryT>
    Entry*
    findLongestPrefixMatch(const EntryT& tableEntry, const EntrySelector& entrySelector = AnyEntry()) const
    {
  ...
  public: // enumeration
     ...
     */
    Range
    partialEnumerate(const Name& prefix, const EntrySubTreeSelector& entrySubTreeSelector = AnyEntrySubTree()) const;
