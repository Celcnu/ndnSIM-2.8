...
class telemetry_server {
  public:
    ...
    void
    run(std::string docroot, uint16_t port)
    {
        std::stringstream ss;
    ...
    set_timer()
    {
        m_timer = m_endpoint.set_timer(1000, websocketpp::lib::bind(&telemetry_server::on_timer, this,
                                                                    websocketpp::lib::placeholders::_1));
    }

    void
    on_timer(websocketpp::lib::error_code const& ec)
    {
        if (ec) {
