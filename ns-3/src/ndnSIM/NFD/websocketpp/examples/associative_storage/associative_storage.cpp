  ...
  public:
    ...
    on_message(connection_hdl hdl, server::message_ptr msg)
    {
        ...
        if (data.name.empty()) {
            ...
            std::cout << "Setting name of connection with sessionid " << data.sessionid << " to " << data.name
                      << std::endl;
        }
        else {
            std::cout << "Got a message from connection " << data.name << " with sessionid " << data.sessionid
                      << std::endl;
        }
    }
