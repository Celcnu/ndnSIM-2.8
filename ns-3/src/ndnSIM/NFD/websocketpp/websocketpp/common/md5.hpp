...
static void
md5_process(md5_state_t* pms, md5_byte_t const* data /*[64]*/)
{
...
void
md5_append(md5_state_t* pms, md5_byte_t const* data, size_t nbytes)
{
...
inline std::string
md5_hash_string(std::string const& s)
{
    char digest[16];
...
inline std::string
md5_hash_hex(std::string const& input)
{
