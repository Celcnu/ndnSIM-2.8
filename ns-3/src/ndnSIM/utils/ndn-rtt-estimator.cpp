    ...
    static TypeId tid =
      TypeId("ns3::ndn::RttEstimator")
        ...
        .AddAttribute("MaxMultiplier", "Maximum RTO Multiplier", UintegerValue(64),
                      MakeUintegerAccessor(&RttEstimator::m_maxMultiplier), MakeUintegerChecker<uint16_t>())
        ...
        .AddAttribute("MinRTO", "Minimum retransmit timeout value",
                      ...
                      MakeTimeAccessor(&RttEstimator::SetMinRto, &RttEstimator::GetMinRto), MakeTimeChecker())
        .AddAttribute("MaxRTO", "Maximum retransmit timeout value", TimeValue(Seconds(200.0)),
                      MakeTimeAccessor(&RttEstimator::SetMaxRto, &RttEstimator::GetMaxRto), MakeTimeChecker());
    return tid;
}
