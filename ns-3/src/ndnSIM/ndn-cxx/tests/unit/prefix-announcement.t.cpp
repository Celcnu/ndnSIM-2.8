...
makePrefixAnnData()
{
    return Data("067A 071A announced-name=/net/example 08036E6574 08076578616D706C65"
...
BOOST_AUTO_TEST_CASE(DecodeGood)
{
    ...
    BOOST_CHECK_EQUAL(*pa0.getValidityPeriod(), security::ValidityPeriod(time::fromIsoString("20181030T000000"),
    ...
    BOOST_CHECK_EQUAL(*pa1.getValidityPeriod(), security::ValidityPeriod(time::fromIsoString("20181030T000000"),
                                                                         time::fromIsoString("20181124T235959")));
...
BOOST_FIXTURE_TEST_CASE(EncodeWithValidity, IdentityManagementFixture)
{
    ...
    pa.setAnnouncedName("/net/example");
    pa.setExpiration(1_h);
    security::ValidityPeriod validity(time::fromIsoString("20181030T000000"), time::fromIsoString("20181124T235959"));
...
BOOST_AUTO_TEST_CASE(Modify)
{
    ...
    pa2.setValidityPeriod(
      security::ValidityPeriod(time::fromIsoString("20180118T000000"), time::fromIsoString("20180212T235959")));
