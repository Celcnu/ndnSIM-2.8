...
BOOST_AUTO_TEST_CASE(SystemClock)
{
    ...
    BOOST_CHECK_EQUAL(toString(referenceTime, "%Y -- %d -- %B", std::locale("C")), "2014 -- 29 -- January");
...
BOOST_AUTO_TEST_CASE(Year2038)
{
    ...
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(year2010), "1262304001042000000 nanoseconds since Jan 1, 1970");
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(year2042), "2272147201042000000 nanoseconds since Jan 1, 1970");
