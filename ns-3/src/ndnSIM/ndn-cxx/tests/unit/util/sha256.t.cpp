...
BOOST_AUTO_TEST_CASE(Basic)
{
    ...
    BOOST_CHECK_EQUAL_COLLECTIONS(expected->data(), expected->data() + expected->size(), digest->data(),
...
{
    const uint8_t input[] = {0x16, 0x1b, // SignatureInfo
...
{
    const uint8_t origin[] = {0x94, 0xEE, 0x05, 0x93, 0x35, 0xE5, 0x87, 0xE5, 0x01, 0xCC, 0x4B,
                              0xF9, 0x06, 0x13, 0xE0, 0x81, 0x4F, 0x00, 0xA7, 0xB0, 0x8B, 0xC7,
