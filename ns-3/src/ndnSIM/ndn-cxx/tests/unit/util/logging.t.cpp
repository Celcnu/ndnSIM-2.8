...
class AbstractClassWithLogger {
  public:
    virtual ~AbstractClassWithLogger() = default;
    ...
    virtual void logFromVirtualFunction() = 0;
...
BOOST_AUTO_TEST_CASE(None)
{
    ...
    Logging::flush();
    BOOST_CHECK(os.is_equal(LOG_SYSTIME_STR + " FATAL: [Module1] fatal1\n"));
}
...
BOOST_AUTO_TEST_CASE(Error)
{
    ...
    Logging::flush();
    BOOST_CHECK(
      os.is_equal(LOG_SYSTIME_STR + " ERROR: [Module1] error1\n" + LOG_SYSTIME_STR + " FATAL: [Module1] fatal1\n"));
}
...
BOOST_AUTO_TEST_CASE(Warn)
{
    ...
    Logging::flush();
    BOOST_CHECK(os.is_equal(LOG_SYSTIME_STR + "  WARN: [Module1] warn1\n" + LOG_SYSTIME_STR
...
BOOST_AUTO_TEST_CASE(Info)
{
    ...
    Logging::flush();
    BOOST_CHECK(os.is_equal(LOG_SYSTIME_STR + "  INFO: [Module1] info1\n" + LOG_SYSTIME_STR
...
BOOST_AUTO_TEST_CASE(Debug)
{
    ...
    Logging::flush();
    BOOST_CHECK(os.is_equal(LOG_SYSTIME_STR + " DEBUG: [Module1] debug1\n" + LOG_SYSTIME_STR
                            + "  INFO: [Module1] info1\n" + LOG_SYSTIME_STR + "  WARN: [Module1] warn1\n"
                            + LOG_SYSTIME_STR + " ERROR: [Module1] error1\n" + LOG_SYSTIME_STR
                            + " FATAL: [Module1] fatal1\n"));
}
...
BOOST_AUTO_TEST_CASE(Trace)
{
    ...
    Logging::flush();
    BOOST_CHECK(os.is_equal(LOG_SYSTIME_STR + " TRACE: [Module1] trace1\n" + LOG_SYSTIME_STR
                            + " DEBUG: [Module1] debug1\n" + LOG_SYSTIME_STR + "  INFO: [Module1] info1\n"
                            + LOG_SYSTIME_STR + "  WARN: [Module1] warn1\n" + LOG_SYSTIME_STR
                            + " ERROR: [Module1] error1\n" + LOG_SYSTIME_STR + " FATAL: [Module1] fatal1\n"));
}
...
BOOST_AUTO_TEST_CASE(NamespaceLogger)
{
    ...
    Logging::flush();
    BOOST_CHECK(os.is_equal(LOG_SYSTIME_STR + "  INFO: [ndn.util.tests.ns1] hello world from ns1\n" + LOG_SYSTIME_STR
                            + "  INFO: [ndn.util.tests.ns2] hi there from ns2\n"));
}
...
BOOST_AUTO_TEST_CASE(MemberLogger)
{
    ...
    Logging::flush();
    BOOST_CHECK(os.is_equal(LOG_SYSTIME_STR + "  INFO: [ndn.util.tests.ClassWithLogger] static member function\n"
    ...
    Logging::flush();
    BOOST_CHECK(os.is_equal(LOG_SYSTIME_STR + "  INFO: [ndn.util.tests.AbstractClassWithLogger] const member function\n"
                            + LOG_SYSTIME_STR
                            + "  INFO: [ndn.util.tests.AbstractClassWithLogger] overridden virtual function\n"));
...
BOOST_AUTO_TEST_CASE(LateRegistration)
{
    ...
    Logging::flush();
    BOOST_CHECK(os.is_equal(LOG_SYSTIME_STR + " DEBUG: [Module3] debugModule3\n" + LOG_SYSTIME_STR
                            + "  INFO: [Module3] infoModule3\n" + LOG_SYSTIME_STR + "  WARN: [Module3] warnModule3\n"
                            + LOG_SYSTIME_STR + " ERROR: [Module3] errorModule3\n" + LOG_SYSTIME_STR
                            + " FATAL: [Module3] fatalModule3\n"));
}
...
BOOST_AUTO_TEST_CASE(Unset)
{
    ...
    Logging::flush();
    BOOST_CHECK(
      os.is_equal(LOG_SYSTIME_STR + " FATAL: [Module1] fatal1\n" + LOG_SYSTIME_STR + " FATAL: [Module2] fatal2\n"));
}
...
BOOST_AUTO_TEST_CASE(Override)
{
    ...
    Logging::flush();
    BOOST_CHECK(
      os.is_equal(LOG_SYSTIME_STR + "  WARN: [Module1] warn1\n" + LOG_SYSTIME_STR + " ERROR: [Module1] error1\n"
...
BOOST_AUTO_TEST_CASE(SetModule)
{
    ...
    Logging::flush();
    BOOST_CHECK(os.is_equal(LOG_SYSTIME_STR + " ERROR: [Module1] error1\n" + LOG_SYSTIME_STR
                            + " FATAL: [Module1] fatal1\n" + LOG_SYSTIME_STR + " FATAL: [Module2] fatal2\n"));
}
