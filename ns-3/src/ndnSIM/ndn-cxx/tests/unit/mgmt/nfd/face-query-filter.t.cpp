...
BOOST_AUTO_TEST_CASE(Encode)
{
    ...
    static const uint8_t expected[] = {
      0x96, 0x41, 0x69, 0x01, 0x64, 0x83, 0x04, 0x74, 0x63, 0x70, 0x34, 0x72, 0x15, 0x74, 0x63, 0x70, 0x34,
      0x3a, 0x2f, 0x2f, 0x31, 0x39, 0x32, 0x2e, 0x30, 0x2e, 0x32, 0x2e, 0x31, 0x3a, 0x36, 0x33, 0x36, 0x33,
      0x81, 0x16, 0x74, 0x63, 0x70, 0x34, 0x3a, 0x2f, 0x2f, 0x31, 0x39, 0x32, 0x2e, 0x30, 0x2e, 0x32, 0x2e,
      0x32, 0x3a, 0x35, 0x35, 0x35, 0x35, 0x35, 0x84, 0x01, 0x01, 0x85, 0x01, 0x01, 0x86, 0x01, 0x01,
    };
...
BOOST_AUTO_TEST_CASE(Print)
{
    ...
    filter.setFaceId(100)
      ...
      .setFacePersistency(FACE_PERSISTENCY_ON_DEMAND)
      .setLinkType(LINK_TYPE_MULTI_ACCESS);
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(filter), "FaceQueryFilter(FaceID: 100,\n"
                                                                "UriScheme: tcp4,\n"
