...
BOOST_AUTO_TEST_CASE(Created)
{
    ...
    static const uint8_t expected[] = {
      0xc0, 0x41, 0xc1, 0x01, 0x01, 0x69, 0x01, 0x14, 0x72, 0x16, 0x74, 0x63, 0x70, 0x34, 0x3a, 0x2f, 0x2f,
      0x31, 0x39, 0x32, 0x2e, 0x30, 0x2e, 0x32, 0x2e, 0x31, 0x3a, 0x35, 0x35, 0x35, 0x35, 0x35, 0x81, 0x15,
      0x74, 0x63, 0x70, 0x34, 0x3a, 0x2f, 0x2f, 0x31, 0x39, 0x32, 0x2e, 0x30, 0x2e, 0x32, 0x2e, 0x32, 0x3a,
      0x36, 0x33, 0x36, 0x33, 0x84, 0x01, 0x01, 0x85, 0x01, 0x01, 0x86, 0x01, 0x01, 0x6c, 0x01, 0x03,
    };
    ...
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(notification2), "FaceEvent(Kind: created,\n"
                                                                       "          FaceId: 20,\n"
...
BOOST_AUTO_TEST_CASE(Destroyed)
{
    ...
    // }
    static const uint8_t expected[] = {
      0xc0, 0x41, 0xc1, 0x01, 0x02, 0x69, 0x01, 0x14, 0x72, 0x16, 0x74, 0x63, 0x70, 0x34, 0x3a, 0x2f, 0x2f,
      0x31, 0x39, 0x32, 0x2e, 0x30, 0x2e, 0x32, 0x2e, 0x31, 0x3a, 0x35, 0x35, 0x35, 0x35, 0x35, 0x81, 0x15,
      0x74, 0x63, 0x70, 0x34, 0x3a, 0x2f, 0x2f, 0x31, 0x39, 0x32, 0x2e, 0x30, 0x2e, 0x32, 0x2e, 0x32, 0x3a,
      0x36, 0x33, 0x36, 0x33, 0x84, 0x01, 0x01, 0x85, 0x01, 0x01, 0x86, 0x01, 0x01, 0x6c, 0x01, 0x04,
    };
    BOOST_CHECK_EQUAL_COLLECTIONS(expected, expected + sizeof(expected), wire.begin(), wire.end());
    ...
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(notification2), "FaceEvent(Kind: destroyed,\n"
                                                                       "          FaceId: 20,\n"
                                                                       "          RemoteUri: tcp4://192.0.2.1:55555,\n"
                                                                       "          LocalUri: tcp4://192.0.2.2:6363,\n"
                                                                       "          FaceScope: local,\n"
...
BOOST_AUTO_TEST_CASE(Up)
{
    ...
    // }
    static const uint8_t expected[] = {
      0xc0, 0x41, 0xc1, 0x01, 0x03, 0x69, 0x01, 0x14, 0x72, 0x16, 0x74, 0x63, 0x70, 0x34, 0x3a, 0x2f, 0x2f,
      0x31, 0x39, 0x32, 0x2e, 0x30, 0x2e, 0x32, 0x2e, 0x31, 0x3a, 0x35, 0x35, 0x35, 0x35, 0x35, 0x81, 0x15,
      0x74, 0x63, 0x70, 0x34, 0x3a, 0x2f, 0x2f, 0x31, 0x39, 0x32, 0x2e, 0x30, 0x2e, 0x32, 0x2e, 0x32, 0x3a,
      0x36, 0x33, 0x36, 0x33, 0x84, 0x01, 0x01, 0x85, 0x01, 0x01, 0x86, 0x01, 0x01, 0x6c, 0x01, 0x05,
    };
    BOOST_CHECK_EQUAL_COLLECTIONS(expected, expected + sizeof(expected), wire.begin(), wire.end());
    ...
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(notification2), "FaceEvent(Kind: up,\n"
                                                                       "          FaceId: 20,\n"
                                                                       "          RemoteUri: tcp4://192.0.2.1:55555,\n"
                                                                       "          LocalUri: tcp4://192.0.2.2:6363,\n"
                                                                       "          FaceScope: local,\n"
...
BOOST_AUTO_TEST_CASE(Down)
{
    ...
    // }
    static const uint8_t expected[] = {
      0xc0, 0x41, 0xc1, 0x01, 0x04, 0x69, 0x01, 0x14, 0x72, 0x16, 0x74, 0x63, 0x70, 0x34, 0x3a, 0x2f, 0x2f,
      0x31, 0x39, 0x32, 0x2e, 0x30, 0x2e, 0x32, 0x2e, 0x31, 0x3a, 0x35, 0x35, 0x35, 0x35, 0x35, 0x81, 0x15,
      0x74, 0x63, 0x70, 0x34, 0x3a, 0x2f, 0x2f, 0x31, 0x39, 0x32, 0x2e, 0x30, 0x2e, 0x32, 0x2e, 0x32, 0x3a,
      0x36, 0x33, 0x36, 0x33, 0x84, 0x01, 0x01, 0x85, 0x01, 0x01, 0x86, 0x01, 0x01, 0x6c, 0x01, 0x06,
    };
    BOOST_CHECK_EQUAL_COLLECTIONS(expected, expected + sizeof(expected), wire.begin(), wire.end());
    ...
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(notification2), "FaceEvent(Kind: down,\n"
                                                                       "          FaceId: 20,\n"
                                                                       "          RemoteUri: tcp4://192.0.2.1:55555,\n"
                                                                       "          LocalUri: tcp4://192.0.2.2:6363,\n"
                                                                       "          FaceScope: local,\n"
