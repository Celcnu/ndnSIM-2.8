...
{
    std::string input = "0123456701234567012345670123456701234567012345670123456701234567"
...
typedef boost::mpl::vector<boost::mpl::integral_c<std::ios_base::iostate, std::ios_base::badbit>,
