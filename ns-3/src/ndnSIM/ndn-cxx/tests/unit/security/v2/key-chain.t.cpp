...
BOOST_FIXTURE_TEST_CASE(GeneralSigningInterface, IdentityManagementFixture)
{
    ...
    std::vector<SigningInfo> signingInfos =
      {SigningInfo(),
       ...
       SigningInfo(
         "hmac-sha256:QjM3NEEyNkE3MTQ5MDQzN0FBMDI0RTRGQURENUI0OTdGREZGMUE4RUE2RkYxMkY2RkI2NUFGMjcyMEI1OUNDRg=="),
...
{
    Certificate cert =
      addIdentity("/Security/V2/TestKeyChain/SelfSignedCertValidity").getDefaultKey().getDefaultCertificate();
