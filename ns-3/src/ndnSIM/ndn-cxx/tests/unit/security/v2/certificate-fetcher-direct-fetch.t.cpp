...
class CertificateFetcherDirectFetchFixture
  : public HierarchicalValidatorFixture<ValidationPolicySimpleHierarchy, CertificateFetcherDirectFetch> {
  public:
    enum class ResponseType { INFRASTRUCTURE, DIRECT, BOTH };
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(ValidateFailureDataNoTagDirectOnly, T, Failures,
