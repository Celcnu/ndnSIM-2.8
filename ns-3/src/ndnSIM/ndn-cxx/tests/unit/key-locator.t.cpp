...
BOOST_AUTO_TEST_CASE(TypeNone)
{
    ...
    //   printf("0x%02x, ", *it);
    // }
    static const uint8_t expected[] = {0x1c, 0x00};
...
BOOST_AUTO_TEST_CASE(TypeName)
{
    ...
    //   printf("0x%02x, ", *it);
    // }
    static const uint8_t expected[] = {0x1c, 0x05, 0x07, 0x03, 0x08, 0x01, 0x4e};
    BOOST_CHECK_EQUAL_COLLECTIONS(expected, expected + sizeof(expected), wire.begin(), wire.end());
...
BOOST_AUTO_TEST_CASE(TypeKeyDigest)
{
    ...
    //   printf("0x%02x, ", *it);
    // }
    static const uint8_t expected[] = {0x1c, 0x0c, 0x1d, 0x0a, 0x12, 0x34, 0x56,
                                       0x78, 0x9a, 0xbc, 0xde, 0xf1, 0x23, 0x45};
    BOOST_CHECK_EQUAL_COLLECTIONS(expected, expected + sizeof(expected), wire.begin(), wire.end());
