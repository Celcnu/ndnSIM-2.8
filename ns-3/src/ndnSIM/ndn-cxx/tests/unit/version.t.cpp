...
BOOST_AUTO_TEST_CASE(VersionNumber)
{
    ...
    BOOST_CHECK_EQUAL(NDN_CXX_VERSION,
                      NDN_CXX_VERSION_MAJOR * 1000000 + NDN_CXX_VERSION_MINOR * 1000 + NDN_CXX_VERSION_PATCH);
}
...
BOOST_AUTO_TEST_CASE(VersionString)
{
    ...
    char buf[12];
    ::snprintf(buf, sizeof(buf), "%d.%d.%d", NDN_CXX_VERSION_MAJOR, NDN_CXX_VERSION_MINOR, NDN_CXX_VERSION_PATCH);
