...
BOOST_AUTO_TEST_CASE(PrintRouteFlags)
{
    ...
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(
                        static_cast<RouteFlags>(ROUTE_FLAG_CHILD_INHERIT | ROUTE_FLAG_CAPTURE)),
                      "child-inherit|capture");
    BOOST_CHECK_EQUAL(boost::lexical_cast<std::string>(static_cast<RouteFlags>(ROUTE_FLAG_CAPTURE | 0x9c)),
                      "capture|0x9c");
}
