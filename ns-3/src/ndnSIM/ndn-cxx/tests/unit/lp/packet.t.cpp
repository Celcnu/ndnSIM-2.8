...
BOOST_AUTO_TEST_CASE(EncodeFragment)
{
    static const uint8_t expectedBlock[] = {
      0x64, 0x0e,                                                 // LpPacket
      0x51, 0x08,                                                 // Sequence
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0xe8, 0x50, 0x02, // Fragment
      0x03, 0xe8,
    };
...
BOOST_AUTO_TEST_CASE(EncodeSortOrder)
{
    static const uint8_t expectedBlock[] = {
      0x64, 0x2e,                                                             // LpPacket
      0x52, 0x01,                                                             // FragIndex
      0x00, 0x53, 0x01,                                                       // FragCount
      0x01, 0xfd, 0x03, 0x44, 0x08,                                           // Ack
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xfd, 0x03, 0x44, 0x08, // Ack
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0xfd, 0x03, 0x44, 0x08, // Ack
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x50, 0x02,             // Fragment
      0x03, 0xe8,
    };
...
BOOST_AUTO_TEST_CASE(DecodeNormal)
{
    static const uint8_t inputBlock[] = {
      ...
      0x00, 0x53, 0x01,                                                       // FragCount
      0x01, 0xfd, 0x03, 0x44, 0x08,                                           // Ack
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0xfd, 0x03, 0x44, 0x08, // Ack
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0xfd, 0x03, 0x44, 0x08, // Ack
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x50, 0x02,             // Fragment
      0x03, 0xe8,
    };
...
BOOST_AUTO_TEST_CASE(DecodeWrongOrderAmongHeaders)
{
    static const uint8_t inputBlock[] = {
      0x64, 0x0a,       // LpPacket
      0x53, 0x01,       // FragCount
      0x01, 0x52, 0x01, // FragIndex
      0x00, 0x50, 0x02, // Fragment
      0x03, 0xe8,
    };
...
BOOST_AUTO_TEST_CASE(DecodeIgnoredHeader)
{
    static const uint8_t inputBlock[] = {
      0x64, 0x0c,                   // LpPacket
      0x52, 0x01,                   // FragIndex
      0x00, 0xfd, 0x03, 0x24, 0x01, // unknown TLV-TYPE 804 (ignored)
      0x02, 0x50, 0x02,             // Fragment
      0x03, 0xe8,
    };
...
BOOST_AUTO_TEST_CASE(DecodeUnrecognizedHeader)
{
    static const uint8_t inputBlock[] = {
      0x64, 0x0c,                   // LpPacket
      0x52, 0x01,                   // FragIndex
      0x00, 0xfd, 0x03, 0x22, 0x01, // unknown TLV-TYPE 802 (cannot ignore)
      0x02, 0x50, 0x02,             // Fragment
      0x03, 0xe8,
    };
...
BOOST_AUTO_TEST_CASE(DecodeBareNetworkLayerPacket)
{
    ...
    BOOST_CHECK_EQUAL_COLLECTIONS(inputBlock, inputBlock + sizeof(inputBlock), encoded.begin(), encoded.end());
}
...
BOOST_FIXTURE_TEST_CASE(DecodePrefixAnnouncement, ndn::tests::IdentityManagementFixture)
{
    ...
    pa.setValidityPeriod(
      security::ValidityPeriod(time::fromIsoString("20181030T000000"), time::fromIsoString("20181124T235959")));
