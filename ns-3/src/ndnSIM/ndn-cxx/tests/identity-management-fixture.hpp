...
class IdentityManagementBaseFixture : public TestHomeFixture<DefaultPibDir> {
  public:
    ...
    bool saveCertToFile(const Data& obj, const std::string& filename);
...
class IdentityManagementFixture : public IdentityManagementBaseFixture {
  public:
     ...
     */
    bool saveCertificate(const security::Identity& identity, const std::string& filename);
     ...
     */
    security::Identity addSubCertificate(const Name& subIdentityName, const security::Identity& issuer,
     ...
     */
    security::v2::Certificate addCertificate(const security::Key& key, const std::string& issuer);
