...
ndnsec_set_default(int argc, char** argv)
{
    ...
    po::options_description description("Usage: ndnsec set-default [-h] [-k|-c] [-n] NAME\n"
                                        "\n"
                                        "Options");
    description.add_options()("help,h", "produce help message")(
      "name,n", po::value<Name>(&name),
      "the identity/key/certificate name to set")("default-key,k", po::bool_switch(&wantSetDefaultKey),
                                                  "set default key of the identity")("default-cert,c",
                                                                                     po::bool_switch(
                                                                                       &wantSetDefaultCert),
                                                                                     "set default certificate of the "
                                                                                     "key");
