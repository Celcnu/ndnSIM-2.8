...
ndnsec_cert_dump(int argc, char** argv)
{
    ...
    description
      .add_options()("help,h", "produce help message")(
        "pretty,p", po::bool_switch(&isPretty), "display certificate in human readable format")("identity,i", po::bool_switch(&isIdentityName), "treat the NAME argument as an identity name (e.g., /ndn/edu/ucla/alice)")("key,k",
                                                                                                                                                                                                                           po::bool_switch(
                                                                                                                                                                                                                             &isKeyName),
                                                                                                                                                                                                                           "treat the NAME argument as a key name (e.g., /ndn/edu/ucla/alice/ksk-123456789)")("file,f", po::bool_switch(&isFileName),
                                                                                                                                                                                                                                                                                                              "treat the NAME argument as the name of a file containing a base64-encoded "
                                                                                                                                                                                                                                                                                                              "certificate, '-' for stdin")("name,n",
                                                                                                                                                                                                                                                                                                                                            po::value<
                                                                                                                                                                                                                                                                                                                                              std::string>(&name),
                                                                                                                                                                                                                                                                                                                                            "unless overridden by -i/-k/-f, the name of the certificate to be exported "
                                                                                                                                                                                                                                                                                                                                            "(e.g., /ndn/edu/ucla/KEY/cs/alice/ksk-1234567890/ID-CERT/%FD%FF%FF%FF%FF%FF%FF%FF)")("repo-output,r",
                                                                                                                                                                                                                                                                                                                                                                                                                                  po::bool_switch(&isRepoOut), "publish the certificate into a repo-ng instance")("repo-host,H",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  po::value<
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    std::
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      string>(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    &repoHost)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ->default_value(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "localhost"),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  "repo hostname if --repo-output is specified")("repo-port,P",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 po::value<
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   std::
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     string>(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   &repoPort)
    ...
    try {
        if (isIdentityName) {
            certificate = keyChain.getPib().getIdentity(name).getDefaultKey().getDefaultCertificate();
        }
        else if (isKeyName) {
