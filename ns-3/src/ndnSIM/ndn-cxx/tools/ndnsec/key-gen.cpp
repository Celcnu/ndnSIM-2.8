...
ndnsec_key_gen(int argc, char** argv)
{
    ...
    po::options_description description("Usage: ndnsec key-gen [-h] [-n] [-t TYPE] [-k IDTYPE] [-i] IDENTITY\n"
                                        "\n"
                                        "Options");
    description.add_options()("help,h", "produce help message")(
      "identity,i", po::value<Name>(&identityName),
      "identity name, e.g., /ndn/edu/ucla/alice")("not-default,n", po::bool_switch(&wantNotDefault),
                                                  "do not set the identity as default")("type,t",
                                                                                        po::value<char>(&keyTypeChoice)
                                                                                          ->default_value('r'),
                                                                                        "key type, 'r' for RSA, 'e' "
                                                                                        "for ECDSA")("keyid-type,k",
                                                                                                     po::value<char>(
                                                                                                       &keyIdTypeChoice)
                                                                                                       ->default_value(
                                                                                                         'r'),
