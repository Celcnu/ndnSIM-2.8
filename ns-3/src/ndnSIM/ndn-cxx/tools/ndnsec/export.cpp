...
ndnsec_export(int argc, char** argv)
{
    ...
    po::options_description description("Usage: ndnsec export [-h] [-o FILE] [-P PASSPHRASE] [-i] IDENTITY\n"
                                        "\n"
                                        "Options");
    description.add_options()("help,h", "produce help message")(
      "identity,i", po::value<Name>(&identityName),
      "name of the identity to export")("output,o", po::value<std::string>(&output)->default_value("-"),
                                        "output file, '-' for stdout (the default)")("password,P",
                                                                                     po::value<std::string>(&password),
                                                                                     "passphrase, will prompt if empty "
                                                                                     "or not specified");
    ...
    auto safeBag = keyChain.exportSafeBag(id.getDefaultKey().getDefaultCertificate(), password.data(), password.size());
