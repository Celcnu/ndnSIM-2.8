...
ndnsec_delete(int argc, char** argv)
{
    ...
    po::options_description description("Usage: ndnsec delete [-h] [-k|-c] [-n] NAME\n"
                                        "\n"
                                        "Options");
    description.add_options()("help,h", "produce help message")(
      "delete-key,k", po::bool_switch(&wantDeleteKey),
      "delete a key")("delete-cert,c", po::bool_switch(&wantDeleteCert),
                      "delete a certificate")("name,n", po::value<std::string>(&name),
