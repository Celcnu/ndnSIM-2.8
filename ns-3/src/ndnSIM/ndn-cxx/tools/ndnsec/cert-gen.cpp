...
ndnsec_cert_gen(int argc, char** argv)
{
    ...
    po::options_description description("Usage: ndnsec cert-gen [-h] [-S TIMESTAMP] [-E TIMESTAMP] [-I INFO]...\n"
    ...
    description
      .add_options()("help,h", "produce help message")(
        ...
        "request file name, '-' for stdin (the default)")("not-before,S", po::value<std::string>(&notBeforeStr),
                                                          "certificate validity start date/time in YYYYMMDDhhmmss "
                                                          "format (default: now)")("not-after,E",
                                                                                   po::value<std::string>(&notAfterStr),
                                                                                   "certificate validity end date/time "
                                                                                   "in YYYYMMDDhhmmss format (default: "
                                                                                   "365 days after the --not-before "
                                                                                   "timestamp)")("info,I",
                                                                                                 po::value<std::vector<
                                                                                                   std::string>>(
                                                                                                   &infos),
