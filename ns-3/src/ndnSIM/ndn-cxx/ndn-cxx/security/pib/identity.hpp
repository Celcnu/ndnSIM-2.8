...
class Identity {
  public:
     ...
     */
    explicit Identity(weak_ptr<detail::IdentityImpl> impl);
     ...
     * @return the default key
     */
    const Key& setDefaultKey(const uint8_t* key, size_t keyLen, const Name& keyName) const;
  ...
  private:
     ...
     */
    shared_ptr<detail::IdentityImpl> lock() const;
