...
class ValidityPeriod {
  ...
  public:
     ...
     */
    explicit ValidityPeriod(const Block& block);
     ...
     */
    ValidityPeriod&
    setPeriod(const time::system_clock::TimePoint& notBefore, const time::system_clock::TimePoint& notAfter);
  ...
  private: // EqualityComparable concept
    ...
    operator!=(const ValidityPeriod& lhs, const ValidityPeriod& rhs)
    {
        return lhs.m_notBefore != rhs.m_notBefore || lhs.m_notAfter != rhs.m_notAfter;
    }
