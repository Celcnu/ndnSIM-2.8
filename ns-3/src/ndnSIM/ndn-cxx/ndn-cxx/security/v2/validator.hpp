...
class Validator : public CertificateStorage {
  public:
     ...
     */
    void validate(const Data& data, const DataValidationSuccessCallback& successCb,
     ...
     * @note @p successCb and @p failureCb must not be nullptr
     */
    void validate(const Interest& interest, const InterestValidationSuccessCallback& successCb,
  ...
  public: // anchor management
     ...
     */
    void loadAnchor(const std::string& groupId, const std::string& certfilePath, time::nanoseconds refreshPeriod,
                    bool isDir = false);
  ...
  private: // Common validator operations
     ...
     */
    void validate(const Certificate& cert, const shared_ptr<ValidationState>& state);
     ...
     */
    void
    requestCertificate(const shared_ptr<CertificateRequest>& certRequest, const shared_ptr<ValidationState>& state);
