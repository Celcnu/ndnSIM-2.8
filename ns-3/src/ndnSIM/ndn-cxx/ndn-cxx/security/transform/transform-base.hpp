...
class Downstream {
  ...
  private:
     ...
     */
    virtual size_t doWrite(const uint8_t* buf, size_t size) = 0;
...
class Transform : public Upstream, public Downstream, noncopyable {
  ...
  private:
     ...
     */
    size_t doWrite(const uint8_t* data, size_t dataLen) final;
     ...
     */
    virtual size_t convert(const uint8_t* data, size_t dataLen) = 0;
