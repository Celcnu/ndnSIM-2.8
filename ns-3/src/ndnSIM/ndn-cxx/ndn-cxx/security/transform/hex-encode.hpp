...
class HexEncode : public Transform {
  public:
     ...
     */
    explicit HexEncode(bool useUpperCase = false);
  ...
  private:
     ...
     */
    unique_ptr<Transform::OBuffer> toHex(const uint8_t* data, size_t dataLen);

  private:
    bool m_useUpperCase;
};

unique_ptr<Transform> hexEncode(bool useUpperCase = false);
