...
class ComponentType : noncopyable {
  ...
  protected:
    ...
    {
        bool isAllPeriods = std::all_of(comp.value_begin(), comp.value_end(), [](uint8_t x) { return x == '.'; });
        if (isAllPeriods) {
            os << "...";
        }
...
getComponentType1()
{
    static const Sha256ComponentType ct1(tlv::ImplicitSha256DigestComponent, "ImplicitSha256DigestComponent",
                                         "sha256digest");
    return ct1;
}
...
getComponentType2()
{
    static const Sha256ComponentType ct2(tlv::ParametersSha256DigestComponent, "ParametersSha256DigestComponent",
                                         "params-sha256");
    return ct2;
}
...
inline ComponentTypeTable::ComponentTypeTable()
{
