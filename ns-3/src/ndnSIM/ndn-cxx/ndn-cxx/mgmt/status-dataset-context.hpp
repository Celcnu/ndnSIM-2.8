...
class StatusDatasetContext : noncopyable {
  public:
    ...
    NDN_CXX_PUBLIC_WITH_TESTS_ELSE_PRIVATE : typedef std::function<void(const Name& dataName, const Block& content,
  ...
  private:
    ...
    NDN_CXX_PUBLIC_WITH_TESTS_ELSE_PRIVATE : shared_ptr<EncodingBuffer> m_buffer;
