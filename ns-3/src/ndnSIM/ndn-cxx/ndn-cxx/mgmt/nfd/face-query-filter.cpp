...
{
    return !this->hasFaceId() && !this->hasUriScheme() && !this->hasRemoteUri() && !this->hasLocalUri()
           && !this->hasFaceScope() && !this->hasFacePersistency() && !this->hasLinkType();
}
...
{
    return a.hasFaceId() == b.hasFaceId() && (!a.hasFaceId() || a.getFaceId() == b.getFaceId())
           && a.hasUriScheme() == b.hasUriScheme() && (!a.hasUriScheme() || a.getUriScheme() == b.getUriScheme())
           && a.hasRemoteUri() == b.hasRemoteUri() && (!a.hasRemoteUri() || a.getRemoteUri() == b.getRemoteUri())
           && a.hasLocalUri() == b.hasLocalUri() && (!a.hasLocalUri() || a.getLocalUri() == b.getLocalUri())
           && a.hasFaceScope() == b.hasFaceScope() && (!a.hasFaceScope() || a.getFaceScope() == b.getFaceScope())
           && a.hasFacePersistency() == b.hasFacePersistency()
           && (!a.hasFacePersistency() || a.getFacePersistency() == b.getFacePersistency())
           && a.hasLinkType() == b.hasLinkType() && (!a.hasLinkType() || a.getLinkType() == b.getLinkType());
}
