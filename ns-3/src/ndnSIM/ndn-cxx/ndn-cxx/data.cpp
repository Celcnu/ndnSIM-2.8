...
static_assert(std::is_base_of<tlv::Error, Data::Error>::value, "Data::Error must inherit from tlv::Error");
...
{
    return lhs.getName() == rhs.getName() && lhs.getMetaInfo().wireEncode() == rhs.getMetaInfo().wireEncode()
