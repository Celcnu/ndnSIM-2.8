...
App::GetTypeId(void)
{
    static TypeId tid =
      TypeId("ns3::ndn::App")
        ...
        .AddTraceSource("ReceivedInterests", "ReceivedInterests", MakeTraceSourceAccessor(&App::m_receivedInterests),
                        "ns3::ndn::App::InterestTraceCallback")

        .AddTraceSource("ReceivedDatas", "ReceivedDatas", MakeTraceSourceAccessor(&App::m_receivedDatas),
                        "ns3::ndn::App::DataTraceCallback")

        .AddTraceSource("ReceivedNacks", "ReceivedNacks", MakeTraceSourceAccessor(&App::m_receivedNacks),
                        "ns3::ndn::App::NackTraceCallback")

        .AddTraceSource("TransmittedInterests", "TransmittedInterests",
                        MakeTraceSourceAccessor(&App::m_transmittedInterests), "ns3::ndn::App::InterestTraceCallback")

        .AddTraceSource("TransmittedDatas", "TransmittedDatas", MakeTraceSourceAccessor(&App::m_transmittedDatas),
                        "ns3::ndn::App::DataTraceCallback")

        .AddTraceSource("TransmittedNacks", "TransmittedNacks", MakeTraceSourceAccessor(&App::m_transmittedNacks),
                        "ns3::ndn::App::NackTraceCallback");
    return tid;
}
...
App::StartApplication() // Called at time specified by Start
{
    ...
    NS_ASSERT_MSG(GetNode()->GetObject<L3Protocol>() != 0, "Ndn stack should be installed on the node " << GetNode());
